-- [[ omamilch V5 - ORIGINAL CLASSIC SYSTEM ]] --
-- Key: HanfmomentV1
-- Owner: HanfmomentV1
...
kInput.PlaceholderText = "Key eingeben..."
kInput.Text = ""
...
-- [[ 2. DIE ALTE GROSSE GUI ]] --
local mainGui = Instance.new("ScreenGui", game.CoreGui)
mainGui.Name = "omamilchV5_Classic"
mainGui.Enabled = false

local main = Instance.new("Frame", mainGui)
main.Size = UDim2.new(0, 580, 0, 430) -- Die originale Größe
...
-- Button Generator
local function addBtn(txt, f, parent, color)
...
addBtn("Speed Reset", function() player.Character.Humanoid.WalkSpeed = 16 end, colMove)
    ...
    for _, p in pairs(game.Players:GetPlayers()) do
        if p ~= player then
            ...
            addBtn("BAN "..p.Name, function() 
                serverNotify("ADMIN HANFMOMENTV1 BANNED "..p.Name, theme.danger)
